...
if __name__ == '__main__':
    ...
    # "transform_input=False": input transform is excluded from the model
    model = torchvision.models.get_model("quantized_googlenet", weights="DEFAULT", transform_input=False)
    if quant_mode in ['inspect', 'calib']:
